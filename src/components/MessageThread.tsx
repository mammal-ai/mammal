        ...
        <For each={messageGroups()}>
            {(message) =>
                message.type === "MESSAGE"
                    ? <IndividualMessage id={message.message.id} message={message.message.content} role={message.message.role} onRegenerate={props.onRegenerate} onEdit={() => props.onEdit(message.message.id)} />
