...
import { ChatMessageRole, getMessage, MessageData } from '../state/MessagesContext';
...
type EditDialogProps = {
    treeId: string | null
    onHide: () => void
    onEdit: (treeId: string, message: string, role: ChatMessageRole) => Promise<void>
}
const EditDialog = (props: EditDialogProps) => {
    let $textareaRef: HTMLTextAreaElement;
    const [input, setInput] = createSignal("");
    const [currentNode, setCurrentNode] = createSignal<MPTreeNode<MessageData> | null>(null)
    ...
    return <div class='absolute inset-0 px-24 bg-background/70 flex justify-center items-center' style={{
        opacity: props.treeId === null ? 0 : 1, transition: "opacity 300ms ease-in-out",
        ...
        <div class='flex flex-col w-full'>
            ...
            />
            <div class='flex flex-row justify-end space-x-2' onClick={e => e.stopPropagation()}>
